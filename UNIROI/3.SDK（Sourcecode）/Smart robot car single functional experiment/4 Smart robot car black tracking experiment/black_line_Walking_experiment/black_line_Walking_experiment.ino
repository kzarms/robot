...
void run()     // ahead
{
  ...
  analogWrite(Right_motor_go,120);//PWM--Pulse Width Modulation(0~255). right motor go speed is 255.
  analogWrite(Right_motor_back,0); 
  digitalWrite(Left_motor_go,HIGH);  // set left motor go ahead
  digitalWrite(Left_motor_back,LOW);
  analogWrite(Left_motor_go,120);//PWM--Pulse Width Modulation(0~255).left motor go speed is 135.
